        ...
        keys.forEach(key => {
            ...
            cardItem.innerHTML = `
                <div class="flex items-center justify-between">
                    ...
                    <div class="right-indicator flex items-center">
                        ${key.errorStatus === 401 || key.errorStatus === 403 ? `
                            <svg class="w-5 h-5 text-yellow-500 warning-icon" title="Error Status: ${key.errorStatus}" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
